      ...
      <div id="fp-wrap">
              ...
              <div className="mc-banner-left">
                ...
                <div>
                  ...
                  <p className="mc-banner-sub">
                    <span>+18 horas de contenido</span>
        ...
        <section className="fp-sec" id="tutorials">
          ...
          <div id="creds">
            ...
            <div className="creds-list">
              ...
              <div className="cred">IMUTES — Instructor</div>
              <div className="cred">D5 Render Masterclass — 18+ horas</div>
            </div>
          </div>
        </section>
        ...
        <section className="fp-sec" id="contact">
          ...
          <div className="ct-links sec-in d2">
            ...
            <a href="https://www.youtube.com/@pedrosardi.studio" target="_blank" rel="noopener" className="ct-btn">
